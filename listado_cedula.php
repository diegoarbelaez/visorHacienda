                                ...
                                <form action="buscar_ficha.php" method="POST">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="ficha" id="cedula" value="94287419">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                ...
                                <form action="buscar_nombre.php" method="POST">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="propietario" id="cedula" value="94287419">
                                        </div>
                                    </div>
                                    <div class="form-row">
                        ...
                        <div class="col-12">
                            <div class="card-box table-responsive">
                                ...
                                <table class="table table-striped table-bordered dt-responsive nowrap compacta" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    <tbody>
                                        <?php
                                        $cedula_buscar = $_POST["cedula"];
                                        $sentencia_consulta = 'SELECT `id`, `No Identificacion`, `Porpietario`,`Direccion`, `Ficha  Catastral`, `Total 2018`,`Total 2019`,`Total 2020`,`Total 2021`,`Total 2022`,`Total 2023`,`Valor a Pagar Vigencia`,`Fecha Vencimiento` FROM ' . $nombre_tabla . ' where `No Identificacion`="'.$cedula_buscar.'"';
                                        ...
                                        ?>
                                            <script type="text/javascript">
                                                //window.location = "listado_cedula.php?pagina=1";
                                            </script>
                                        <?php
                                        } else {
                                            $iniciar = ($_GET['pagina'] - 1) * $elementosxpagina;
                                            $sql = mysqli_query($con, 'SELECT `id`, `No Identificacion`, `Porpietario`,`Direccion`, `Ficha  Catastral`, `Total 2018`,`Total 2019`,`Total 2020`,`Total 2021`,`Total 2022`,`Total 2023`,`Valor a Pagar Vigencia`,`Fecha Vencimiento` FROM ' . $nombre_tabla . ' where `No Identificacion`="'.$cedula_buscar.'" order by id ASC LIMIT ' . $iniciar . ',' . $elementosxpagina);
                                ...
                                <div class="card-footer clearfix">
                                    <ul class="pagination pagination-sm m-0 float-right">
                                        <li class="page-item <?php echo $_GET['pagina'] <= 1 ? 'disabled' : '' ?>">
                                            <a class="page-link" href="listado_cedula.php?pagina=<?php echo $_GET['pagina'] - 1 ?>">
                                                Anterior
                                            </a>
                                        </li>
                                        <?php for ($i = 0; $i < $paginas; $i++) : ?>
                                            <li class="page-item <?php echo $_GET['pagina'] == $i + 1 ? 'active' : '' ?>"><a class="page-link" href="listado_cedula.php?pagina=<?php echo $i + 1  ?>"><?php echo $i + 1  ?></a></li>
                                        <?php endfor ?>
